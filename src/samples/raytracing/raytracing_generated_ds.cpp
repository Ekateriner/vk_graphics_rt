...
void RayTracer_Generated::InitAllGeneratedDescriptorSets_CastSingleRay()
{
  ...
  //
  // descriptor set #0: CastSingleRayMegaCmd (["out_color","indices_buf","inst_matrices","meshes","vertices_buf","m_pAccelStruct","mat_indices_buf","lights","materials"])
  {
    ...
    std::array<VkAccelerationStructureKHR,  9 + additionalSize> accelStructs;
    std::array<VkWriteDescriptorSetAccelerationStructureKHR,  9 + additionalSize> descriptorAccelInfo;
    ...
    descriptorBufferInfo[1].buffer = m_vdata.indices_bufBuffer;
    descriptorBufferInfo[1].offset = m_vdata.indices_bufOffset;
    ...
    descriptorBufferInfo[2].buffer = m_vdata.inst_matricesBuffer;
    descriptorBufferInfo[2].offset = m_vdata.inst_matricesOffset;
    ...
    descriptorBufferInfo[3].buffer = m_vdata.meshesBuffer;
    descriptorBufferInfo[3].offset = m_vdata.meshesOffset;
    ...
    descriptorBufferInfo[4].buffer = m_vdata.vertices_bufBuffer;
    descriptorBufferInfo[4].offset = m_vdata.vertices_bufOffset;
    ...
    descriptorBufferInfo[6].buffer = m_vdata.mat_indices_bufBuffer;
    descriptorBufferInfo[6].offset = m_vdata.mat_indices_bufOffset;
    ...
    descriptorBufferInfo[7].buffer = m_vdata.lightsBuffer;
    descriptorBufferInfo[7].offset = m_vdata.lightsOffset;
    ...
    descriptorBufferInfo[8].buffer = m_vdata.materialsBuffer;
    descriptorBufferInfo[8].offset = m_vdata.materialsOffset;
